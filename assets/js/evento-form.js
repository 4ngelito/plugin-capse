+function ($) { "use strict";
    var EventoForm = function () {
        this.$form = $('#evento-form')
    ...
    EventoForm.prototype.addToolbarButton = function() {
    ...
    EventoForm.prototype.initPreview = function() {
        this.initImageUploaders()
    }

    EventoForm.prototype.updateScroll = function() {
        // Reserved in case MarkdownEditor uses scrollbar plugin
        // this.$preview.data('oc.scrollbar').update()
    }

    EventoForm.prototype.initImageUploaders = function() {
        var self = this
    ...
    EventoForm.prototype.pauseUpdates = function() {
        this.$markdownEditor.markdownEditor('pauseUpdates')
    }

    EventoForm.prototype.resumeUpdates = function() {
        this.$markdownEditor.markdownEditor('resumeUpdates')
    }

    EventoForm.prototype.initDropzones = function() {
    ...
    EventoForm.prototype.initFormEvents = function() {
    ...
    EventoForm.prototype.initLayout = function() {
        $('#Form-secondaryTabs .tab-pane.layout-cell:not(:first-child)').addClass('padded-pane')
    }

    EventoForm.prototype.replacePlaceholder = function(placeholder, placeholderHtmlReplacement, mdCodePlaceholder, mdCodeReplacement) {
        this.pauseUpdates()
